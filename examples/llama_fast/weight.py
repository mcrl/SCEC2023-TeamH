...
from tensorrt_llm.models import LLaMAFastForCausalLM
...
def load_from_hf_llama(tensorrt_llm_llama: tensorrt_llm.models.LLaMAFastForCausalLM,
                       hf_llama,
                       mapping=Mapping(),
                       dtype='float32'):
...
def load_from_meta_llama(
        tensorrt_llm_llama: tensorrt_llm.models.LLaMAFastForCausalLM,
        meta_ckpt_dir,
        mapping=Mapping(),
        dtype="float32"):
    torch_dtype = str_dtype_to_torch(dtype)
...
def load_from_binary(tensorrt_llm_llama: LLaMAFastForCausalLM,
                     dir_path,
                     mapping=Mapping(),
                     fp16=False,
...
def load_from_awq_llama(tensorrt_llm_llama: LLaMAFastForCausalLM,
                        quant_ckpt_path,
                        mapping=Mapping(),
                        dtype="float16"):
    tensorrt_llm.logger.info(
