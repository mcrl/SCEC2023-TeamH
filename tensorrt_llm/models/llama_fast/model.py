...
class LLaMAFastDecoderLayer(Module):
...
class LLaMAFastModel(Module):
    ...
    def __init__(self,
        ...
        self.layers = ModuleList([
            LLaMAFastDecoderLayer(layer_id=i,
...
class LLaMAFastForCausalLM(LLaMAFastModel, GenerationMixin):
